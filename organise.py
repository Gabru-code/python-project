...
from_dir = "C:/Users/Pavi/Downloads"
to_dir = "C:/Users/Pavi/Pictures/downloadpdf"
...
for file_name in list_of_files:
    ...
    if extension in ['.pdf']:
        ...
        path3 = to_dir + '/' + "Pdf_files" + '/' + file_name   # Example path3 : D:/My Files/Image_Files/ImageName1.jpg
        #print("path1 " , path1)
        #print("path3 ", path3)
